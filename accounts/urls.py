...
from accounts.views import service_views, user_views, role_permission_views
...
urlpatterns = [
    ...
    path(
        'services',
        service_views.ServiceListCreateView.as_view(),
    ...
    path(
        'users/<uuid:user_id>',
        user_views.UserDetailUpdateDeleteView.as_view(),
        name='user-detail'
    ),
    path(
